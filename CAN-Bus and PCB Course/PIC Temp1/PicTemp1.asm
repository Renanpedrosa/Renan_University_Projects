...
_init_main:
;PicTemp1.c,57 :: 		void init_main()
;PicTemp1.c,60 :: 		}
	RETURN      0
; end of _init_main

_main:
;PicTemp1.c,62 :: 		void main()
;PicTemp1.c,80 :: 		TRISA  = 0xFF;               //PortA é entrada
	MOVLW       255
	MOVWF       TRISA+0 
;PicTemp1.c,81 :: 		ADCON1 = 0x0C;               //RA0, RA1 e RA2 são ent. analógicas.
	MOVLW       12
	MOVWF       ADCON1+0 
;PicTemp1.c,82 :: 		TRISB  = 0x08;               //RB2 é saída(TXD) e RB3 é entrada (RXD)
	MOVLW       8
	MOVWF       TRISB+0 
;PicTemp1.c,83 :: 		TRISC  = 0;                  //PortC é saída
	CLRF        TRISC+0 
;PicTemp1.c,84 :: 		OSCCON = 0b01110011;         //Oscilador interno selecionado(8MHz)
	MOVLW       115
	MOVWF       OSCCON+0 
;PicTemp1.c,95 :: 		mask = -1;
	MOVLW       255
...
;PicTemp1.c,105 :: 		_CAN_TX_NO_RTR_FRAME;
	MOVLW       244
	MOVWF       main_Send_Flags_L0+0 
;PicTemp1.c,106 :: 		Read_Flags = 0;
	CLRF        main_Read_Flags_L0+0 
;PicTemp1.c,109 :: 		CANInitialize(SJW, BRP, Phase_Seg1, Phase_Seg2, Prop_Seg, Init_Flags);
	MOVLW       1
...
;PicTemp1.c,112 :: 		CANSetOperationMode(_CAN_MODE_CONFIG,0xFF);               // set CONFIGURATION mode
	MOVLW       128
	MOVWF       FARG_CANSetOperationMode_mode+0 
	MOVLW       255
	MOVWF       FARG_CANSetOperationMode_WAIT+0 
	CALL        _CANSetOperationMode+0, 0
;PicTemp1.c,113 :: 		CANSetMask(_CAN_MASK_B1,mask,_CAN_CONFIG_XTD_MSG);          // set all mask1 bits to ones
...
;PicTemp1.c,114 :: 		CANSetMask(_CAN_MASK_B2,mask,_CAN_CONFIG_XTD_MSG);          // set all mask2 bits to ones
	MOVLW       1
	...
	MOVWF       FARG_CANSetMask_CAN_CONFIG_FLAGS+0 
	CALL        _CANSetMask+0, 0
;PicTemp1.c,115 :: 		CANSetFilter(_CAN_FILTER_B2_F3,ID_ReqT1,_CAN_CONFIG_XTD_MSG);// set id of filter B2_F3 to 1st Temp req
	MOVLW       4
...
;PicTemp1.c,118 :: 		CANSetOperationMode(_CAN_MODE_NORMAL,0xFF);               // set NORMAL mode
	CLRF        FARG_CANSetOperationMode_mode+0 
	MOVLW       255
	MOVWF       FARG_CANSetOperationMode_WAIT+0 
	CALL        _CANSetOperationMode+0, 0
;PicTemp1.c,120 :: 		while(1)
L_main0:
;PicTemp1.c,122 :: 		dt = 0;
	CLRF        main_dt_L0+0 
;PicTemp1.c,125 :: 		dt = CANRead(&Rx_ID, RxTx_Data, &len, &Read_Flags);
...
L__main6:
	BSF         LATC6_bit+0, 6 
L__main7:
;PicTemp1.c,131 :: 		if((Rx_ID == ID_ReqT1)&& dt)
...
L__main8:
	...
	GOTO        L_main4
L__main5:
;PicTemp1.c,133 :: 		temp = ADC_Read(0);
	CLRF        FARG_ADC_Read_channel+0 
	CALL        _ADC_Read+0, 0
;PicTemp1.c,134 :: 		mV = (unsigned long)temp * 5000/1024;
	MOVLW       0
	MOVWF       R2 
	MOVWF       R3 
	MOVLW       136
...
L__main9:
	...
	GOTO        L__main9
L__main10:
;PicTemp1.c,135 :: 		temperature = mV/10;
	MOVF        R4, 0 
	MOVWF       R0 
	MOVF        R5, 0 
	MOVWF       R1 
...
;PicTemp1.c,136 :: 		RxTx_Data[0] = temperature;
	MOVF        R0, 0 
	MOVWF       main_RxTx_Data_L0+0 
;PicTemp1.c,137 :: 		CANWrite(ID_Temp1, RxTx_Data, 1, Send_Flags);
	MOVLW       232
