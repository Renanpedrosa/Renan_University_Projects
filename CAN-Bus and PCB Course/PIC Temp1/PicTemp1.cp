#line 1 "C:/Users/Renan/Documents/Eletrônica/FSAE/Aula Protocolo CAN/PIC Temp1/PicTemp1.c"
#line 54 "C:/Users/Renan/Documents/Eletrônica/FSAE/Aula Protocolo CAN/PIC Temp1/PicTemp1.c"
...
void main()
{
 ...
 CANSetFilter(_CAN_FILTER_B2_F3,ID_ReqT1,_CAN_CONFIG_XTD_MSG);
 ...
 if((Rx_ID == ID_ReqT1)&& dt)
 {
 temp = ADC_Read(0);
 mV = (unsigned long)temp * 5000/1024;
 temperature = mV/10;
 RxTx_Data[0] = temperature;
 CANWrite(ID_Temp1, RxTx_Data, 1, Send_Flags);
 }
