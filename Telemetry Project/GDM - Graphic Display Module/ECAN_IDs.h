...
long const BSM_DIGI_1  =  3040 ; // Entradas Digitais 1 do BSM. A entrada DIG1 é binária e as entradas DIG2 a 4 são entradas de frequência.
long const BSM_DIGI_2  =  3050 ; // Entradas Digitais 2 do BSM. As entradas DIG5 até DIG8 são binárias. DIG7 e DIG8 não estão conectadas na parte externa.
